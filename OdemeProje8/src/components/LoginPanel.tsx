...
const LoginPanel: React.FC<Props> = ({ onLoginSuccess, onShowRegister, onShowForgot }) => {
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 12 }}>
        ...
        <button onClick={onShowForgot} style={{ background: "none", color: "#4CAF50", border: "none", cursor: "pointer", textDecoration: "underline", marginLeft: 8 }}>
          Şifremi Unuttum
        </button>
      </div>
    </div>
